...
/**
 * @fileoverview A class for word-wrapping strategies.
...
/**
 * A class for word-wrapping strategies.  The class can indent for each line.
...
/**
 * Indent strategy.
 * @type {module:lib/publishing/Indent}
 * @private
 */
...
/**
 * Line buffer.
 * @type {module:lib/publishing/WordWrapper.LineBuffer}
 * @private
 */
 ...
 * @type {module:lib/publishing/WordWrapper.WordSplitter}
 * @private
 */
 ...
 * @param {Array.<module:lib/dom/InlineElement>} contents Elements to wrap.
 ...
 * strategy for {@link module:lib/publishing/WordWrapper#wrap}. The {@code wrap}
 ...
 * Use {@link module:lib/dom/InlineElement#isBreakable} when inline content
 * was arrived.  Wraps in the content if the {@code isBreakable} returns a true.
 * @param {Array.<module:lib/dom/InlineElement>|string} contents Elements
 *     to split.
 ...
 * @return {module:lib/publishing/WordWrapper.LineBuffer} This instance.
 */
