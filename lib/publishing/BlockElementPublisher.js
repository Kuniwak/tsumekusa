...
/**
 * @fileoverview An abstract class for block element publishers.
...
/**
 * An abstract class for block element publishers.
 * @constructor
 * @implements {module:lib/publishing/IElementPublisher}
 * @exports lib/publishing/BlockElementPublisher
 */
 ...
 * @param {module:lib/dom/BlockElement} element Block element.
 * @return {module:lib/dom/BlockElementPublisher} Publisher of the parent
 ...
 * @param {module:lib/dom/BlockElement} element Block element to get an
 *     indent width.
 ...
 * @param {module:lib/dom/BlockElement} element Block element to get a word
 *     wrapper.
 * @return {module:lib/publishing/Indent} Created object for
 *     indentation.
 * @protected
