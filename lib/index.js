...
var tsumekusa = {
  ...
  /**
   * An alias for contents table elements.
   * @type {module:lib/dom/ContentsTable}
   */
  get ContentsTable(){
  ...
  /**
   * An alias for tag element factories.
   * @type {module:lib/dom/TagFactory}
   */
  get TagFactory(){
