 ...
 * @constructor
 */
DefinitionList.Definition = function(opt_term, opt_descs) {
  BlockElement.call(this);
...
/** @override */
DefinitionList.Definition.prototype.setParent = function(parent) {
  BlockElement.prototype.setParent.call(this, parent);
  var refHelper = parent ? parent.getReferenceHelper() : null;

  this.term_.setReferenceHelper(refHelper);
  this.descs_.setReferenceHelper(refHelper);
  return this;
};
...
DefinitionList.Definition.prototype.setTerm = function(term) {
  ...
  if (this.term_) {
    // Prepare to remove a current term.
...
DefinitionList.Definition.prototype.setDescriptions = function(descs) {
  if (this.descs_) {
    // Prepare to remove a current descriptions.
...
DefinitionList.Definition.prototype.getListType = function() {
  return this.getParentDefinitionList().getListType();
};
